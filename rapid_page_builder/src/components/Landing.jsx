      ...
      <div className="outer flex">
        <div className="left flex flex-col justify-between w-20">
          <div className="top">
            ...
            <svg
              className="mt-6 bg-gray-200 ml-4 p-1"
              width="52"
              height="40"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <div className="right flex justify-center items-center">
          <div className="flex middle border-2 justify-between rounded">
            <div className="ileft flex flex-col justify-center items-start m-auto">
              <h2 className="font-bold text-2xl ">No pages Found</h2>
            ...
            <div className="flex flex-col justify-center items-start m-auto">
              <img src="loader.svg" alt="no photo" className="pr-20" />
            </div>
          </div>
        </div>
      </div>
